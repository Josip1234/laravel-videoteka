...
<nav
   ...
   <a href="{{ route('medij.noviMedij') }}" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Unos novog medija</a>
   <a href="{{ route('medij.pocetna') }}" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Povratak na početnu medija</a>
