<nav
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('videoteka.pocetna') }}" aria-current="page"
                            ...
                            videoteke</a>
                        <a href="{{ route('medij.pocetna') }}" aria-current="page"
    ...
    <el-disclosure id="mobile-menu" hidden class="block sm:hidden">
        <div class="space-y-1 px-2 pt-2 pb-3">
            ...
            <a href="{{ route('videoteka.pocetna') }}" aria-current="page"
                class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Početna
                stranica videoteke</a>
