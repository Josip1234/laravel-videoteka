...
<nav class="relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
    ...
    <a href="{{ route('vrsta.pocetna') }}" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Početna stranica vrste cjenika</a>
    <a href="{{ route('vrsta.noviCjenik') }}" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white">Dodaj novu vrstu cjenika</a>
                </div>
                </div>
            </div>
        </div>
